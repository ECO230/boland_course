...
::: {.column width="40%"}
<br> <br> <br> <br>
![](media/images/w01_s22_stack.png){fig-alt="An ordered stack of multiple atomic units making it possible to summarize the data with measures and summary statistics." width="100%"}
:::
