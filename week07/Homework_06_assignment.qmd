...
Render this document to PDF and submit `Homework_06_IP.pdf` in Canvas. Your PDF
must contain your responses for Hypotheses 2 and 3 and the code you attempted
for Hypothesis 3. Keep `Homework_06_IP.qmd` in your Posit Cloud project so you can
revise it if needed.
...
- [ ] I submitted `Homework_06_IP.pdf` in Canvas.
