...
ui <- fluidPage(
  ...
  fluidRow(
    column(
      ...
      div(
        class = "callout-left",
        div(style="font-weight:700; margin-bottom:.35rem;", "Teaching point (read this aloud)"),
        div(
          class = "small",
          HTML(
            "<b>Correlation (r)</b> measures <b>linearity</b>, not how steep a line is.<br>
             Multiply Y by 10: slope changes a lot, but r stays the same.<br><br>
             <b>r = 0</b> means “no <i>linear</i> relationship.”<br>
             You can still have a strong <b>nonlinear</b> pattern."
          )
        )
      )
    ),
